        ...
        <main className="relative z-10 flex items-center justify-center min-h-screen">
          <div className="w-full max-w-6xl mx-auto px-4 md:px-6 py-24">
            ...
            >
              ...
              {/* Amount Input */}
              {mode !== "ore" && <div className="bg-slate-800/50 rounded-xl p-4 mb-4 border border-slate-700/30">
              ...
              {mode === "swap" && (
                <SwapMode
                  ...
                  setSwapRecipient={setSwapRecipient}
                  connected={connected}
                  publicKey={publicKey}
                  isLoading={isLoading}
                />
              ...
              {/* Ore Mode */}
              {mode === "ore" && <OreMode solBalance={solBalance} />}
              {/* Fee Display */}
              {mode !== "ore" && (
